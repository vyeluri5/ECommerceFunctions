...
namespace EcommFunctions.Functions.Interfaces
{
    public interface IEcommFunction : IDisposable
    {
        ...
        Task<object> GetProductAsync<TInput, TType>(TInput input, TType options = default(TType));
        ...
        /// <returns></returns>
        Task<object> CreateProductAsync<TInput, TType>(TInput input, TType options = default(TType));
    }
}
